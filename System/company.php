...
$company_id = $_GET['ref'];
	...
	$comppostal_address = $row['postal_address'];
...
<head>
	...
	<title>TelmeIn Raco -company <?php echo "$compname"; ?></title>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$comppostal_address"; ?> <?php echo "$compcity"; ?>. <?php echo "$compstreet"; ?>, <?php echo "$compcountry"; ?> <span class="mh-5">|</span> <i class="fa fa-phone"></i> <?php echo "$compphone"; ?></p>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>
											TTelmeln Raco Investment is an online job management 
