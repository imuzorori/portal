...
<head>
	...
	<title>TelmeIn Raco - <?php echo "$jobtitle"; ?></title>
					...
					<div class="row">
							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$postal_address"; ?> <?php echo "$city"; ?>. <?php echo "$street"; ?>, <?php echo "$country"; ?> <span class="block"> <i class="fa fa-phone"></i> <?php echo "$myphone"; ?></span></p>
										...
										<form class="post-form-wrapper" action="app/update-job.php" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="city" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobcity == $row['city_name']) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option> <?php
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label>Country</label>
														<input name="country" value="<?php echo "$jobcountry"; ?>"  required type="text" class="form-control" placeholder="Enter country">
													</div>
