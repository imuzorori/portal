...
<head>
	...
	<title>TelmeIn Raco - Company Profile</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">TelmeIn Raco Jobs</a></li>
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<div class="row gap-20">
												...
												<div class="col-sm-6 col-md-4">
                                                    ...
                                                    <input name="year" placeholder="when was the company created" type="text" class="form-control" value="<?php echo "$esta"; ?>" required>
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Type</label>
                                                    <input class="form-control" placeholder="Enter field of company " name="type" required type="text" value="<?php echo "$mytitle"; ?>" required> 
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Postal Adresss</label>
														<input name="postal_address" required type="text" class="form-control" value="<?php echo "$postal_address"; ?>" placeholder="Enter your postal">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Country</label>
														<input name="country" required type="text" class="form-control" value="<?php echo "$country"; ?>" placeholder="Enter your city">
													</div>
