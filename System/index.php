...
<head>
	...
	<title>TelmeIn Reco - Job Portal</title>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>For the best jobs of your choice</h1>
					<p>No professional qualification no worries. we assist you to get a well paying job</p>
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2 style="text-transform:capitalize;">Random Companies</h2>
					...
					<a target="_blank" href="company.php?ref=<?php echo $row['member_no']; ?>" style="text-transform:capitalize;">View Company</a>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="process-item clearfix">
								...
								<div class="icon">
								<i class="fa fa-usd" aria-hidden="true"></i></i>
								</div>
								
								<div class="content">
									<h5>01 / Our Pricing</h5>
						...
						<div class="col-sm-4">
							...
							<div class="process-item clearfix">
								...
								<div class="content">
									<h5>02 / Applicants</h5>
									<P style="font-size: 12px;">
							-->  Premium users: nominal fee $3, <br>
							-->  for registration and profile creation
										 <br>
							-->  Training fee:  $5
									</P>
								</div>
						...
						<div class="col-sm-4">
							...
							<div class="process-item clearfix">
								...
								<div class="content">
									<h5>03 / Employers</h5>
									<p style="font-size: 12px;">
							--> Placement fee: job matching $10
										<br>
							--> Subscription fee: 2 per months
									</p>
								</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-9">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										<h5 class="footer-title" style="text-transform:capitalize;">Quick Links</h5>
										<ul class="footer-menu clearfix">
											<li><a href="./" style="text-transform:capitalize;">Home</a></li>
											<li><a href="job-list.php" style="text-transform:capitalize;">Job List</a></li>
											<li><a href="employers.php" style="text-transform:capitalize;">Employers</a></li>
											<li><a href="employees.php" style="text-transform:capitalize;">Employees</a></li>
											<li><a href="contact.php" style="text-transform:capitalize;">Contact Us</a></li>
											<li><a href="#" style="text-transform:capitalize;">Go to top</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>
									Address : 662 Muvanga Street Wadzanai Township.Shamva
								</p>
