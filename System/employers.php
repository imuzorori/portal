...
<head>
	...
	<title>TelmeIn Reco - Employers</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li style="text-transform:capitalize;"><span>Employers</span></li>
					</ol>
						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title" style="text-transform:capitalize;">Employers</h3>
								</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> TelmeIn Reco Software</p>
