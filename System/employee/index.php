...
<head>
	...
	<title>TelmeIn Raco - Employee Profile</title>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="city" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($mycity == $row['city_name']) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option> <?php
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="postal_address" required type="text" class="form-control" value="<?php echo "$mypostal_address"; ?>">
													</div>
