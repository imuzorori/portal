...
$stmt = $conn->prepare("INSERT INTO tbl_academic_qualification (member_no, city, institution, course, level, timeframe, certificate, transcript) VALUES 
(:member, :city, :institution, :course, :level, :timeframe, '$certificate', '$transcript')");
