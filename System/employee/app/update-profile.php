...
$postal_address = ucwords($_POST['postal_address']);
$about = $_POST['about'];
$phone = $_POST['phone'];
$country = $_POST['country'];
	...
	$stmt = $conn->prepare("UPDATE tbl_users SET first_name = :fname, last_name = :lname, gender = :gender, bdate = :bdate , bmonth = :bmonth , byear = :byear, email = :email, education = :education, title = :title, city = :city, street = :street, postal_address = :postal_address, country = :country, phone = :phone, about = :about WHERE member_no='$myid'");
	...
	$_SESSION['mypostal_address'] =$postal_address;
