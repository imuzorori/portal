...
if ($certificate == "") {
$sql = "UPDATE tbl_profess_qualification SET city = '$city', institution = '$institution', title = '$course', timeframe = '$timeframe' WHERE id='$id' AND member_no = '$myid'";
...
$sql = "UPDATE tbl_profess_qualification SET city = '$city', institution = '$institution', title = '$course', timeframe = '$timeframe', certificate = '$certificate'  WHERE id='$id' AND member_no = '$myid'";
