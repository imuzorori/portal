...
$stmt = $conn->prepare("UPDATE tbl_references SET ref_name = :refname, ref_mail = :refmail, ref_title = :reftitle, ref_phone = :refphone, institution = :institution WHERE id= :refid AND member_no = '$myid'");
