...
<head>
	...
	<title>TelmeIn Raco - Referees</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM tbl_references WHERE member_no = '$myid' ORDER BY id LIMIT $page1,5");
                                    $stmt->execute();
								...
								$total_records = 0;
                                    ...
                                    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                                    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                                    $stmt = $conn->prepare("SELECT * FROM tbl_references WHERE member_no = '$myid' ORDER BY id");
                                    $stmt->execute();
                                    $result = $stmt->fetchAll();
